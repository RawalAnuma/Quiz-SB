...
<div class="flex justify-center items-center min-h-screen pt-20">
    <div class="w-full max-w-md bg-gradient-to-br from-yellow-100 via-orange-100 to-rose-100 p-8 rounded-xl shadow-lg">
        <h1 class="text-2xl font-bold mb-6 text-rose-800 text-center">Sign Up</h1>
        <form action="${pageContext.request.contextPath}/user" method="post" class="space-y-4">

            <div>
                <label for="fullName" class="block mb-2 text-rose-900 font-semibold">Full Name:</label>
        ...
        <p class="mt-4 text-center text-rose-900">
            ...
            <a href="${pageContext.request.contextPath}/login" class="font-semibold hover:underline text-rose-800">Login here</a>
        </p>
    </div>
</div>
