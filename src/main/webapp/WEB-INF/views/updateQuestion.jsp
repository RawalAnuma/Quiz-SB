...
<div class="form-container" style="font-family: Arial, sans-serif; background: #f0f2f5; display: flex; justify-content: center; align-items: center; height: 100vh;">
    <div class="container" style="width: 600px; background: #fff; padding: 30px; border-radius: 10px; box-shadow: 0 0 15px rgba(0,0,0,0.1);">
        <div class="form">
            <form action="${pageContext.request.contextPath}/questions/updateQuestion/${question.questionId}" method="post">
                <input type = "hidden" name = "_method" value = "put"/><br>
                <h1 class="text-2xl font-bold mb-4">Update Question</h1>
                <input type="hidden" name="questionId" value="${questionId}"/><br>
                ...
                <input type="submit" value="Update Question" class="w-full bg-blue-500 text-white p-2 rounded hover:bg-blue-600">
            </form>
        </div>
    </div>
</div>
