                ...
                <tbody>
                    <c:forEach var="score" items="${scores}" varStatus="status">
                        <tr class="${status.index % 2 == 0 ? 'bg-amber-100' : 'bg-beige-200'} hover:bg-olive-200 transition">
                            ...
                            <td class="px-6 py-3 text-olive-800 border border-olive-800">${score.quiz.noOfQuestionsToPlay}</td>
                            <td class="px-6 py-3 font-semibold text-olive-700 border border-olive-800">${score.score}</td>
                            <td class="px-6 py-3 text-olive-800 border border-olive-800">${score.playedDate}</td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
