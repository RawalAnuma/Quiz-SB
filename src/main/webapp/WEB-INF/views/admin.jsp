...
<div class = "form-container" style="font-family: Arial, sans-serif; background: #f0f2f5; display: flex; justify-content: center; align-items: center; height: 100vh;">
    <div class="container" style="width: 400px; background: #fff; padding: 30px; border-radius: 10px; box-shadow: 0 0 15px black;">
        <div class="form">
            ...
            <input type="text" id="categoryName" name="categoryName" class="w-full p-2 mb-4 border rounded border-black" required><br>

            <label for="categoryDescription" class="block mb-2">Category Description:</label>
            <textarea id="categoryDescription" name="categoryDescription" class="w-full p-2 mb-4 border rounded border-black" required></textarea><br>
